...
HTMLActuator.prototype.actuate = function (grid, metadata) {
  ...
  window.requestAnimationFrame(function () {
    ...
    self.updateNextTile(metadata.nextTile);
...
HTMLActuator.prototype.updateNextTile = function (nextTile) {
  var className = "next-" + nextTile.type;
  var classes = ["next-tile-container", className];
  // this.nextTileContainer.setAttribute("class", className);
  this.applyClasses(this.nextTileContainer, classes);
}
